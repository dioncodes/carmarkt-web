...
Website for CarMarkt, a free automotive workshop in Muelheim an der Ruhr. The app is built with Nuxt 3, Vue 3, Tailwind CSS, and a small Nitro API endpoint that sends contact form requests through Resend.
...
- Core business content should be updated in `data/site.ts` first so pages and components stay consistent.
